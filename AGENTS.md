...
MicroAgent is an embeddable AI agent core library (~10,400 LOC, 34 tools, 1017 unit tests).
...
python -m pytest tests/unit/ tests/smoke/ tests/e2e/ -q   # 1037 tests total
