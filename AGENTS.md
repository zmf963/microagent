...
MicroAgent is an embeddable AI agent core library (~13,200 LOC, 34 tools, 1559 tests).
...
├── src/microagent/
│   ├── __init__.py          # Public API surface (~67 symbols)
...
python -m pytest tests/unit/ tests/smoke/ tests/e2e/ -q   # 1559 tests total
