...
[![Tests](https://img.shields.io/badge/tests-1689%20passed-brightgreen.svg)]()

A Python-implemented, embeddable universal AI agent core library.
**~15,550 LOC**, **34 built-in tools**, **70 public API symbols**, **1689 unit+smoke+e2e tests, 3 integration tests**.
