...
[![Tests](https://img.shields.io/badge/tests-1590%20passed-brightgreen.svg)]()

A Python-implemented, embeddable universal AI agent core library.
**~13,600 LOC**, **34 built-in tools**, **68 public API symbols**, **1590 unit+smoke+e2e tests, 3 integration tests**.
