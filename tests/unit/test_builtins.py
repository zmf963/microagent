...
class TestRegistryAllBuiltins:
    def test_all_tools_registered(self, registry):
        expected = {"read_file", "bash", "write_file", "edit_file", "grep", "glob", "web_fetch", "web_search", "execute_code", "vision_analyze", "browser_navigate", "browser_snapshot", "browser_click", "browser_type", "context7", "session_search", "todo", "plan", "exit", "task", "skill_manage"}
